...
- **Pre-Push Verification**: ALWAYS run the `definition-of-done` skill before pushing. This will execute the project's full verification suite via `./.agents/skills/definition-of-done/scripts/verify_done.sh`. Do not push if any checks fail.
