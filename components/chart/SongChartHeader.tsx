...
import { TimeSignature } from '@/lib/types/groove';
    ...
    <div className="border-b-2 border-gray-800 pb-4 mb-6">
      <div className="flex justify-between items-baseline">
        ...
        <div className="flex gap-8 text-lg font-bold text-gray-700">
          {bpm && (
            <div>
              <span className="text-sm font-normal text-gray-500 uppercase mr-2 tracking-widest">BPM</span>
              {bpm}
            </div>
          )}
          <div>
            <span className="text-sm font-normal text-gray-500 uppercase mr-2 tracking-widest">Time</span>
